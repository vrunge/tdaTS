...
#'
#' @description Function generating a tibble with 2 columns named (x,y) with 2D data forming in a 1by1 square with a hole in its center of size \code{Hole_Relative_length}
